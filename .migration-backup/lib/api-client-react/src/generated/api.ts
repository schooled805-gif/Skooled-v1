...
export const createTimetableEntry = async (
  timetableEntryInput: TimetableEntryInput,
  options?: RequestInit,
): Promise<TimetableEntry> => {
...
export const updateTimetableEntry = async (
  id: string,
  timetableEntryUpdate: TimetableEntryUpdate,
  options?: RequestInit,
): Promise<TimetableEntry> => {
 ...
 */
export const getListParentStudentLinksUrl = (
  params?: ListParentStudentLinksParams,
) => {
  const normalizedParams = new URLSearchParams();
  ...
  return stringifiedParams.length > 0
    ? `/api/parent-student-links?${stringifiedParams}`
    : `/api/parent-student-links`;
};

export const listParentStudentLinks = async (
  params?: ListParentStudentLinksParams,
  options?: RequestInit,
): Promise<ParentStudentLink[]> => {
  return customFetch<ParentStudentLink[]>(
    getListParentStudentLinksUrl(params),
    {
      ...options,
      method: "GET",
    },
...
export const getListParentStudentLinksQueryKey = (
  params?: ListParentStudentLinksParams,
) => {
  return [`/api/parent-student-links`, ...(params ? [params] : [])] as const;
};

export const getListParentStudentLinksQueryOptions = <
  TData = Awaited<ReturnType<typeof listParentStudentLinks>>,
  TError = ErrorType<unknown>,
>(
  params?: ListParentStudentLinksParams,
  options?: {
    query?: UseQueryOptions<
      Awaited<ReturnType<typeof listParentStudentLinks>>,
      TError,
      TData
    >;
    request?: SecondParameter<typeof customFetch>;
  ...
  const queryKey =
    queryOptions?.queryKey ?? getListParentStudentLinksQueryKey(params);

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof listParentStudentLinks>>
  > = ({ signal }) =>
    listParentStudentLinks(params, { signal, ...requestOptions });
...
export type ListParentStudentLinksQueryResult = NonNullable<
  Awaited<ReturnType<typeof listParentStudentLinks>>
>;
...
export function useListParentStudentLinks<
  TData = Awaited<ReturnType<typeof listParentStudentLinks>>,
  TError = ErrorType<unknown>,
>(
  params?: ListParentStudentLinksParams,
...
export const createParentStudentLink = async (
  parentStudentLinkInput: ParentStudentLinkInput,
  options?: RequestInit,
): Promise<ParentStudentLink> => {
  return customFetch<ParentStudentLink>(getCreateParentStudentLinkUrl(), {
    ...
    method: "POST",
    headers: { "Content-Type": "application/json", ...options?.headers },
    body: JSON.stringify(parentStudentLinkInput),
  });
};

export const getCreateParentStudentLinkMutationOptions = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type CreateParentStudentLinkMutationResult = NonNullable<
  Awaited<ReturnType<typeof createParentStudentLink>>
>;
export type CreateParentStudentLinkMutationBody =
  BodyType<ParentStudentLinkInput>;
export type CreateParentStudentLinkMutationError = ErrorType<unknown>;

/**
 * @summary Link a parent to a student
 */
export const useCreateParentStudentLink = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export const getDeleteParentStudentLinkMutationOptions = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type DeleteParentStudentLinkMutationResult = NonNullable<
  Awaited<ReturnType<typeof deleteParentStudentLink>>
>;
 ...
 * @summary Remove a parent-student link
 */
export const useDeleteParentStudentLink = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
